...
namespace NeoCortexApi.Encoders
{
    ...
    /// <summary>
    /// Defines the <see cref="ScalarEncoderImproved" />
    /// </summary>
    public class ScalarEncoderImproved : EncoderBase
    {
        /// <summary>
        ...
        /// </summary>
        public ScalarEncoderImproved()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ScalarEncoderImproved"/> class.
        /// </summary>
        /// <param name="encoderSettings">The encoderSettings<see cref="Dictionary{string, object}"/></param>
        public ScalarEncoderImproved(Dictionary<string, object> encoderSettings)
        {
        ...
        public ScalarEncoderImproved(string[] args)
        {
            if (args.Length <= 1)
            {
